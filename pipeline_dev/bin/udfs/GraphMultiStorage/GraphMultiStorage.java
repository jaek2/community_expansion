 ...
 */
public class GraphMultiStorage extends StoreFunc {
  ...
  public GraphMultiStorage(String parentPathStr, String splitFieldIndex) {
      ...
      return new RecordWriter<List<String>, Tuple>() {
        ...
        public void write(List<String> key, Tuple val) throws IOException {
          ...
          if (DataType.findType(field) != DataType.NULL){
            String sid = (String) field;
            mOut.write(sid.getBytes(UTF8));
          } else{
            return;
          }
